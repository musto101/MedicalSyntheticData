# run survival xgboost model on real data
import pandas as pd
...
real_data = pd.read_csv('data/mci_preprocessed_wo_csf_real.csv')

train, test = train_test_split(real_data, test_size=0.2, random_state=0)

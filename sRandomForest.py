...
y_test = test[['last_DX', 'last_visit']].to_records(index=False)
...
# define grid search
grid_search = GridSearchCV(estimator=RandomSurvivalForest(), param_grid=params, cv=5, verbose=1, n_jobs=-1)
...
# run survival random forest model

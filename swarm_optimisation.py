...
train = pd.read_csv('data/mci_preprocessed_wo_csf_vae.csv').values # read in data
...
latent_space.to_csv('data/generated_mci_data2.csv', index=False)

# Training Loss: -0.3231673172216096
# Average validation loss: -1.4247792053222657
# time 2m:58
